:information_source: This repository has been archived on favour of the now official [TestKube Gradle Executor](https://github.com/testkube/testkube-executor-gradle)
